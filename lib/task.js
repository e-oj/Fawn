...
function getFuture(obj, results) {
  var ojf = "$ojFuture";
  ...
  Object.keys(obj).forEach(function (key) {
    if (isObject(obj[key])) {
      if (obj[key][ojf]) {
        ...
        // "index.property.property.-----.property"
...
var testObj = {
  name: {$ojFuture: "0.pet.name"}
  , kids: {
    kid1: {$ojFuture: "0.pet.kids.kid2"}
  }
  , spoof: "Yo"
  , somethingElse: "blah"
};

getFuture(testObj, testResults);
